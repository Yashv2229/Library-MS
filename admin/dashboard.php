    ...
    <div class="content-wrapper">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-3 col-xs-6" onclick="window.location.href='reg-students.php';">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-3 col-xs-6" onclick="window.location.href='manage-publications.php';">
            <div class="alert alert-success back-widget-set text-center">
          ...
          <div class="col-md-3 col-sm-3 col-xs-6" onclick="window.location.href='manage-categories.php';">
            <div class="alert alert-info back-widget-set text-center">
